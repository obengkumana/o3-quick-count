...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			this.fnInfo( '<h6>Menyalin Tabel</h6>'+
				'<p>Menyalin '+len+' baris'+plural+' ke clipboard.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Pratinjau Cetak</h6><p>Silahkan pergunakan fungsi pencetak dengan menekan tombol CTRL+P "+
		  "cetak tabel ini. Tekan tombol Esc jika sudah selesai .",
		"sMessage": "http://obengkumana.net - http://obengkumana.com",
		"bShowAll": true,
		"sToolTip": "Lihat pratinjau Cetak",
